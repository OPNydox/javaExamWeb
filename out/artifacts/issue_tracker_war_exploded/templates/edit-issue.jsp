...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="jumbotron">
                    <c:set value="${issueViewModel}" var="issueViewModel"></c:set>
                    <form method="post">
                        ...
                        <div class="form-group">
                            <select name="status" class="form-control" required>
                                <optgroup label="Status">
                                    <option disabled hidden selected>${issueViewModel.status}</option>
                                    <option>New</option>
                        ...
                        <div class="form-group">
                            <select name="priority" class="form-control" required>
                                <optgroup label="Priority">
                                    <option disabled hidden selected>${issueViewModel.priority}</option>
                                    <option>Low</option>
